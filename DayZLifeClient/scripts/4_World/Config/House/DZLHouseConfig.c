class DZLHouseConfig {
    ...
    void DZLHouseConfig() {
        if(!Load()) {
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_Shed_W6", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("2 -3.2 7");
            storagePosition.Insert("-1.851562 -3.190286 5");
            storagePosition.Insert("0 -0.09 0");
            houseConfigs.Insert(new DZLHouseDefinition("Land_Garage_Office", 100, 50, storagePosition, 10));
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_Factory_Small", 100, 50, storagePosition, 10));
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1B01_Pub", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-0.821289 -1.452631 -0.679687");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W10", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-0.821289 -1.452631 -0.679687");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W10_Brown", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-3 -2.46 4");
            storagePosition.Insert("1.200195 -2.46 -3.5");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W03", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-5.5 -1.97 1");
            storagePosition.Insert("-2.5 -1.97 -3.799805");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W09_Yellow", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-1.991211 -2.67 -4.677246");
            storagePosition.Insert("-0.910156 -2.67 4.00293");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W04", 100, 50, storagePosition, 10));
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_2W01", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-0.78418 -1.89 3.508301");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W08", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-0.78418 -1.89 3.508301");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W08_Brown", 100, 50, storagePosition, 10));
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_2B02", 100, 50, storagePosition, 10));
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_2B01", 100, 50, storagePosition, 10));
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W07", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-2.516602 -2.65 -2.958008");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W11", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("4.485352 -1.024 -1.217285");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W05", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("4.485352 -1.024 -1.217285");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W05_Yellow", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-3.883789 -2.86 2.432129");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W01", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-1.719727 -0.912988 0.538574");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_1W06", 100, 50, storagePosition, 10));
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_2W02", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-2.71582 -5.559998 3.258789");
            storagePosition.Insert("-5.491211 -0.769997 -0.188965");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_2W03", 100, 50, storagePosition, 10));
            ...
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_2W04", 100, 50, storagePosition, 10));

            storagePosition = new array<vector>;
            storagePosition.Insert("-4.385742 -5.169998 3.672363");
            storagePosition.Insert("3.120117 -0.800003 3.993652");
            storagePosition.Insert("7.071289 -0.800003 2.034668");
            houseConfigs.Insert(new DZLHouseDefinition("Land_House_2W04_Yellow", 100, 50, storagePosition, 10));
