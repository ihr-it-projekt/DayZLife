...
static string DAY_Z_LIFE_SERVER_FOLDER_DATA_ITEM_STORAGE = "$profile:TBMods\\Data\\DayZLife\\ItemStorage\\";
static string DAY_Z_LIFE_SERVER_FOLDER_DATA_FRACTION = "$profile:TBMods\\Data\\DayZLife\\Fraction\\";
