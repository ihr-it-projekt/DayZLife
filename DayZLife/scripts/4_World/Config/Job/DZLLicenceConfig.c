	...
	void DZLLicenceConfig() {
        if (!Load()) {
            ...
            if (DAY_Z_LIFE_DEBUG) {
                ...
                licences.collection.Insert(new DZLLicence(109, 150, "Copper Licence", "2876.725830 215.348999 12604.768555", 5, "", new DZLLicenceCraftedItem("DZL_Copper", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
				
				craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Coal", 2, 50));
                craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Iron", 1, 10));
                licences.collection.Insert(new DZLLicence(109, 150, "Iron Licence", "7235.813965 6.100000 3231.249268", 5, "Copper Licence", new DZLLicenceCraftedItem("DZL_Iron", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
				
				craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Coal", 2, 50));
                craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Gold", 1, 10));
                licences.collection.Insert(new DZLLicence(109, 150, "Gold Licence", "4112.656738 324.450012 8913.142578", 5, "Iron Licence", new DZLLicenceCraftedItem("DZL_Gold", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
                ...
                licences.collection.Insert(new DZLLicence(109, 150, "Woodplank Licence", "5783.562988 474.809998 15207.916016", 5, "", new DZLLicenceCraftedItem("DZL_WoodenPlank", 2, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
                toolItems = new DZLLicenceToolItemCollection;
                ...
                licences.collection.Insert(new DZLLicence(109, 150, "Cannabis Licence", "10241.296875 237.953644 5052.820313", 5, "", new DZLLicenceCraftedItem("DZL_Cannabis_Brick", 5, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
				
				craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Cocain", 10, 50));
                licences.collection.Insert(new DZLLicence(109, 150, "Cocain Licence", "3691.775635 402.000000 5972.513672", 5, "", new DZLLicenceCraftedItem("DZL_Cocain_Brick", 5, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
