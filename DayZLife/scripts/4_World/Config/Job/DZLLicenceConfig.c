	...
	void DZLLicenceConfig() {
        if (!Load()) {
            ...
            if (DAY_Z_LIFE_DEBUG) {
                ...
                toolItems.collection.Insert(new DZLLicenceToolItem("Sledgehammer", 1, 10));
                licences.collection.Insert(new DZLLicence(109, 100, "", "7999 117 12616", 5, "Cement Licence", new DZLLicenceCraftedItem("DZL_Cement", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
                toolItems = new DZLLicenceToolItemCollection;
				
				craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Coal", 2, 50));
                craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Copper", 1, 10));
                licences.collection.Insert(new DZLLicence(109, 100, "", "2876 215 12606", 5, "Copper Licence", new DZLLicenceCraftedItem("DZL_Copper", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
				
				craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Coal", 2, 50));
                craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Iron", 1, 10));
                licences.collection.Insert(new DZLLicence(109, 100, "Copper Licence", "7695 6 3193", 5, "Iron Licence", new DZLLicenceCraftedItem("DZL_Iron", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
				
				craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Coal", 2, 50));
                craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_Ore_Gold", 1, 10));
                licences.collection.Insert(new DZLLicence(109, 100, "Iron Licence", "4207 324 8963", 5, "Gold Licence", new DZLLicenceCraftedItem("DZL_Gold", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
                ...
                licences.collection.Insert(new DZLLicence(109, 100, "Gold Licence", "7081 355 14572", 5, "Diamond Licence", new DZLLicenceCraftedItem("DZL_Diamond", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
                ...
                licences.collection.Insert(new DZLLicence(109, 100, "Diamond Licence", "7306 263 7053", 5, "Jewelry Licence", new DZLLicenceCraftedItem("DZL_Jewelry", 1, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
                toolItems = new DZLLicenceToolItemCollection;
                ...
                licences.collection.Insert(new DZLLicence(109, 100, "", "5721 474 15228", 5, "Woodplank Licence", new DZLLicenceCraftedItem("DZL_WoodenPlank", 2, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
                toolItems = new DZLLicenceToolItemCollection;
				
				craftItems.collection.Insert(new DZLLicenceCraftItem("DZL_WoodenPlank", 1, 50));
                toolItems.collection.Insert(new DZLLicenceToolItem("Hacksaw", 1, 10));
                licences.collection.Insert(new DZLLicence(109, 100, "", "12905 7 6263", 5, "Papier Licence", new DZLLicenceCraftedItem("DZL_Paper", 5, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
                toolItems = new DZLLicenceToolItemCollection;
                ...
                licences.collection.Insert(new DZLLicence(109, 100, "Papier Licence", "8884 222 11661", 5, "Falschgeld Licence", new DZLLicenceCraftedItem("DZL_Money", 5, 100), 5, toolItems, craftItems));
                craftItems = new DZLLicenceCraftItemCollection;
